...
export const CHANNELS: readonly Channel[] = [
  ...
  { key: "madaniy", label: "Madaniy meros", sum: "madaniy_sum", accept: "madaniy_accept", sent: "sent_madaniy" },
  { key: "sport", label: "Sport", sum: "sport_sum", accept: "sport_accept", sent: "sent_sport" },
  { key: "defence", label: "PF-16", sum: "defense_sum", accept: "defence_accept", sent: "sent_defence" },
